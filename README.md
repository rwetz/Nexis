...
- **[ML Lab](https://wiki.nexisdev.org/ml-suite/)** — train small models on your own data, locally, with live charts, an inference playground, and run comparison. See [ML_LAB_GUIDE.md](ML_LAB_GUIDE.md).
...
- **[docs/vault/](docs/vault/Home.md)** — contributor-facing architecture map of the codebase (module maps, subsystem guides, flows)
- **[ML_LAB_GUIDE.md](ML_LAB_GUIDE.md)** / **[ML_SUITE.md](ML_SUITE.md)** — ML Lab usage guide and architecture
- **[SECURITY.md](SECURITY.md)** — security posture and reporting

## Based on Terax

Nexis started as a personal fork of [terax-ai](https://github.com/crynta/terax-ai) — an open-source AI terminal by [@crynta](https://github.com/crynta). The core PTY architecture and AI tooling are rooted in that work; Nexis builds on top with its own direction, branding, and an expanded feature set.
