...
export function ThreadsBackground({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      const u = program.uniforms as Record<string, { value: { r: number; g: number; b: number } }>;
      u.iResolution.value.r = clientWidth;
      u.iResolution.value.g = clientHeight;
      u.iResolution.value.b = clientWidth / clientHeight;
    };
