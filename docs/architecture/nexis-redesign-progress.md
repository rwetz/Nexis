...
### Slice 12: Integration panel ownership and E2E preflight

- Debugger, Database, Ports, SSH, HTTP Client, Share, and ML Lab now declare their saved sidebar routes from their owning capabilities. App no longer imports their panel implementations or carries their render branches; the existing rail IDs, pack gates, ordering, lazy loading, and unmount behavior remain unchanged.
