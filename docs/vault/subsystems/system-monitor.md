...
- **`sysinfo` is pinned feature-minimal** (`system`, `disk`, `network`). Defaults pull `component`, `user`, and rayon. The dep costs ~168 KiB of the <15 MB release budget — re-measure before adding a feature.
